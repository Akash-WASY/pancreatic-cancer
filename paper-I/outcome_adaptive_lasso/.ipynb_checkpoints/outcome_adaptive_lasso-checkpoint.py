...
def calc_outcome_adaptive_lasso(A, Y, X, gamma_convergence_factor=2, log_lambdas=None):
    ...
    if log_lambdas is None:
        # log_lambdas = [-2, -1, -0.75, -0.5, -0.25, 0.25, 0.49]
        log_lambdas = [-4.791339,6.739686,-8.728991,11.089071,-5.492427,-23.878899, 9.901651]
    n = A.shape[0]
    ...
    ate_vec = [x - (max(ate_vec)+1) for x in ate_vec]
